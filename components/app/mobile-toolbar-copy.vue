    ...
    <template #container>
      <div class="flex h-full flex-col pb-[56px] gap-8">
        ...
        <div class="overflow-y-auto mx-10">
          <template v-for="item in mainNavigation.navigationLinks" :key="item._key">
            <div v-if="item.linkType === 'int' && item.internalLink.reference._id === 'articleCollectionNavigation'">
              <article-collection-navigation />
            </div>
            <div v-if="item.linkType === 'int' && item.internalLink.reference._id === 'printifyCollectionNavigation'">
                            ...
                            <div class="flex w-full cursor-pointer items-center justify-between px-4 py-0">
                              <div class="flex basis-1/2 gap-2 text-nowrap">
                                <div v-if="child.imageUrl"
                                  ...
                                  <img v-if="child.imageUrl" class="rounded-full object-cover" :src="child.imageUrl" />
                                </div>
        ...
        <div
          ...
          <NuxtLink to="/products" class="cursor-pointer" @click="toggleNav()"><span class="font-brand font-xl">25% off
              all
              products in Store</span></NuxtLink>
        </div>
      </div>
    </template>
  </Sidebar>
