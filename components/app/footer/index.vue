    ...
    <div class="mx-auto min-h-fit max-w-[1280px]">
      <div class="flex flex-wrap pt-6 text-left lg:text-left">
        <div class="w-full px-4 md:w-1/2">
          <h4 class="font-brand text-xl md:text-2xl lg:text-3xl">
            {{ settings.title }}
          </h4>
          <h5 class="mb-2 mt-0 text-base md:text-xl lg:text-lg h-[3em]">
          ...
          <div class="mb-6 mt-6 flex gap-6 lg:mb-0">
            <client-only>
              <div v-for="connection in settings.primaryLocation.socialConnections" :key="connection._key">
                <NuxtLink :to="connection.userUrl" target="_blank" class="text-2xl md:text-4xl lg:text-5xl">
