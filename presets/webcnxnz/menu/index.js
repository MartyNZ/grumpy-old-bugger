export default {
    ...
    itemContent: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-surface-500 dark:text-surface-600': !context.focused && !context.active,
                'text-surface-500 dark:text-surface-600 bg-surface-200 dark:bg-surface-600/90': context.focused && !context.active,
